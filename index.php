...
<div class="banner">
    <div class="container">
        <h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn; color: navy;"> Rental Mobil - Agiel Reri</h1>
    </div>
</div>
<div class="container">
    <div class="col-md-5 bann-infol wow fadeInLeft animated" data-wow-delay=".5s">
        ...
        <div class="ban-top">
            <div class="bnr-left">
                ...
                <select name="nama">
                    ...
                    <option value="pilih">Jazz</option>
                    <option value="pilih">Lamborgini</option>
                    <option value="pilih">Honda Brio</option>
                <?php
