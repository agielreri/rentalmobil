...
<a href="index.php">Rental <span>Mobil <span>Agiel Reri</span></span></a>
</div>
...
<div class="banner">
    <div class="container">
        <h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn; color: blue;"> Rental Mobil - Agiel Reri</h1>
    </div>
</div>
</div>
<!--- /banner-1 --->
...
<div class="selectroom">
          ...
          echo "<div class='selectroom_top'> 
            <div class='col-md-4 selectroom_left wow fadeinLeft animated' data-wow-delay='.5s'>
                <img src='gambar/".$m['gambar']."' class='img-responsive' alt=''>
                  ...
                  <div class='col-md-8 selectroom_right wow fadelInRight animated' data-wow-delay='.5s'>
                       <h2>$m[nama]</h2>
                       <p>$n[1] - $n[2]</p>
                       <ul>
                                <li>
                                            ...
                                            <div class='grand'>
                                                ...
                                                <div class='clearfix'></div>
                                                    ...
                                                    <div class="selectroom_top">
                                                        ...
                                                        <br>
                                                        <form method="post">
                                                            <div class="selectroom-info aimated wow fadeInUp animated"data-wow-duration="1200ms"
                                                            data-wow-delay="500ms" style="visibility: visible; animation-delay: 500ms; animation-name: fadeInUp;">
                                                                <div class="bnr-right">
                                                                    <label class="inputLabel">Tanggal Pinjam</label>
                                                                    <input class="date" name="tglawal" id="datepicker" type="text" placeholder="dd-mm-yy"
                                                                    onfocus="this.value ='';" onblur="if (this.value == '' {this.value = 'yyyy-mm-dd';}" required=>
                                                                </div>
                                                                <br><br><br>
                                                                <div class='bus-txt4'>
                                                                    <div class="sear">
                                                                ...
                                                                <?php
                                                                if(isset($_POST['book'])){
                                                                    $idmobil = $_POST['idmmobil'];
                                                                    $harga = $_POST['harga'];
                                                                    $dari = $_POST['dari'];
                                                                    $tuju = $_POST['tuju'];
                                                                    $tglawal = $_POST['tglawal'];
                                                                    $newDate = date("Y-m-d", strtime($tglawal));
                                                                    $tglakhir = $_POST['tglakhir'];
                                                                    $newDate2 = date("Y-m-d", strtime($tglakhir));
                                                                    $status = 1;
                                                                    $kode = $do->acak(10);
                                                                    $userid = $_SESSION['userid'];
                                                                    if(!empty($tglawal) and !empty($tglakhir)){
                                                                        //echo "<script>alert('$newDate1')</script>";
                                                                        $proses = $do->reservasi($idmobil,$userid,$kode,$harga,$dari,$tuju,$newDate1,$newDate2,$newDate1status);
                                                                    }else{
                                                                ...
                                                                <script>
                                                                    $(function() {
                                                                    $( "#adatepiker,#datepicker" ).datepicker();
                                                                    });
                                                                    </script>
                                                                    <!---/End-date-piker---->
    ...
    <div class="container">
        <div class="col-md-5 footer-left wow fadeInLeft animated" data-wow-delay=".5s">
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                            ...
                                            <section>
                                                <div class="modal-body modal-spa">
                                                    <div class="login-grids">
                                                       ...
                                                       <input type="text" name="password" placeholder="Masukkan password Anda">
                                                       <input type="text" name="noktp" placeholder="Masukkan No KTP Anda">
                                                       <input type="submit" name="daftar" valu="CREATE ACCOUNT">
                                            </form>
                                            </div>
                                            <div class="clearfix"></div>
                                            ...
                                            <div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModallabel">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content modal-info">
                                                        <div class="modal-header">
                                                            <botton type="button" class="close" data-dismiss="modal" arial-label="Close">
                                            ...
                                            <div class="modal-body modal-spa">
                                                <div class="login-grids">
                                                    <div class="login">
                                                        <div class="login-right">
                                                            <form action="prosesdaftar.php" method="post" onsubmit="return validasi-input(this)">
                                                            <h3>Masuk Dengan Akun Anda</h3>
                                                            <input type="text" name="username" placeholder="Masuk username Anda">
